...
2026.07.16 新增不同屏幕分辨率下实时改变字体大小功能。

2026.06.22 新增从流量包中绘制IP地址网络拓扑图功能、并提取HTTP请求单独放在一个标签页下。

2026.06.21 新增从流量包中分析账号密码凭证功能。

2026.06.20 新增DNS流量展示标签页的自研模型的DGA研判功能。

2026.06.19 修复部分pcapng打不开的问题，优化pcapng格式转换功能，大大提升兼容性问题。

2026.06.18 新增pcap包自动适配功能，修复pcap包纳米精度打开报错问题。
