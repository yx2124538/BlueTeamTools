...
**ABC_123也录制了20节关于蓝队分析研判工具箱的系列使用教程，欢迎关注我的B站号（希水涵一讲堂）：**

[https://www.bilibili.com/video/BV1fLaDe2ERk/](https://www.bilibili.com/video/BV1fLaDe2ERk/)

2026.07.23 解决类名冲突造成的图形界面编译后的jar包显示不全问题。

2026.07.18 解决字体大小更改产生的软件界面多个组件显示不全问题。

2026.07.16 解决不同屏幕分辨率下该实时改变字体大小功能。

2026.06.22 新增从流量包中绘制IP地址网络拓扑图功能、并提取HTTP请求单独放在一个标签页下。

2026.06.21 新增从流量包中分析账号密码凭证功能。

2026.06.20 新增DNS流量展示标签页的自由模型的DGA研判功能。

2026.06.19 修复部分pcapng打不开的问题，优化pcapng格式转换功能，大大提升pcap包兼容问题。

2026.06.18 新增pcap包自动是被功能，修复pcap包纳米精度打开报错问题。

2026.06.16 新增GeoIP查询缓存功能，加快pcap包分析速度。

2026.06.15 新增python bytes的16进制编码的反编译及反序列化方式。

2026.03.22 新增NTLM加密方式。

2026.03.01 对内存马分析、Java序列化数据包、Shiro反序列化、CAS反序列化等分析功能添加AI识别功能。

2026.02.28 新增DeepSeek接口识别内存马、webshell流量、反序列化数据包的研判功能。

2026.01.09 新增DGA恶意域名的AI识别模块，加载GPU算力训练的XGBoost模型。

2025.12.07 新增QuiltFlower内存马反编译功能。

2025.11.21 更新Shiro反序列化数据包解密的序列化文件解析抛出异常bug。

2025.11.20 提升Java序列化文件解析速度，修复该功能抛出异常的bug。

2025.11.19 更新netstat -an端口连接功能图形化图表化展示。

2025.11.18 大幅度更新编码、解码功能，以应对复杂的加密混淆。

2025.11.03 大幅度修复编码/解码功能的多出bug，并优化其功能。
